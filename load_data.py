...
# 打开 .pkl 文件进行读取
with open('pkl_data/g1/walk1_subject1.pkl', 'rb') as file:
...
print(data['g1_walk1_subject1']['root_trans_offset'].shape)
print(data['g1_walk1_subject1']['pose_aa'].shape)
print(data['g1_walk1_subject1']['dof'].shape)
print(data['g1_walk1_subject1']['root_rot'].shape)